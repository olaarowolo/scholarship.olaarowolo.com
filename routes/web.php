...
Route::middleware(['auth', 'two-factor', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/applications/notes/{noteId}/toggle', [App\Http\Controllers\AdminController::class, 'toggleAdminNote'])->name('applications.notes.toggle');
    Route::delete('/applications/notes/{noteId}', [App\Http\Controllers\AdminController::class, 'deleteAdminNote'])->name('applications.notes.delete');
