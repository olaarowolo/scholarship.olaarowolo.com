    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <p class="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
                See how the OA Scholarship is transforming lives and communities.
            </p>
        </div>
    </div>
</header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="card bg-white p-8 rounded-xl shadow-lg">
                <div class="flex items-center mb-4">
                    <div class="h-12 w-12 bg-primary text-white rounded-full flex items-center justify-center font-bold text-lg">A</div>
                    <div class="ml-4">
                ...
                <p class="text-gray-600 italic">
                    "The OA Scholarship gave me the financial freedom to focus on my studies. I'm now in my final year with a First Class GPA, pursuing my dream of becoming an engineer."
                </p>
            </div>
            ...
            <div class="card bg-white p-8 rounded-xl shadow-lg">
                <div class="flex items-center mb-4">
                    <div class="h-12 w-12 bg-primary text-white rounded-full flex items-center justify-center font-bold text-lg">C</div>
                    <div class="ml-4">
                ...
                <p class="text-gray-600 italic">
                    "Without this scholarship, medical school would have been impossible. The mentorship program has been invaluable in helping me navigate university life."
                </p>
            </div>
            ...
            <div class="card bg-white p-8 rounded-xl shadow-lg">
                <div class="flex items-center mb-4">
                    <div class="h-12 w-12 bg-primary text-white rounded-full flex items-center justify-center font-bold text-lg">K</div>
                    <div class="ml-4">
                ...
                <p class="text-gray-600 italic">
                    "This scholarship represents hope for Iba Town's youth. It's not just financial aid; it's an investment in our community's future leaders."
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="card bg-white p-8 rounded-xl shadow-lg">
                ...
                <p class="text-gray-600">
                    Our scholars regularly return to Iba Town to mentor secondary school students, sharing their experiences and inspiring the next generation.
                </p>
            </div>
            ...
            <div class="card bg-white p-8 rounded-xl shadow-lg">
                ...
                <p class="text-gray-600">
                    Graduates are encouraged to contribute to local development projects, ensuring that the benefits of education flow back to the community.
                </p>
            </div>
        </div>
    </div>
