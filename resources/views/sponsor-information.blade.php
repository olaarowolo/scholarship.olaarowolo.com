    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <p class="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
                Learn how you can support the OA Scholarship and make a difference in Iba Town's future.
            </p>
        </div>
    </div>
</header>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg mx-auto">
            ...
            <p class="text-gray-600 mb-6">
                The OA Scholarship relies on generous sponsors to provide financial support to deserving students from Iba Town. Your contribution directly impacts the lives of young people pursuing higher education.
            </p>
            ...
            <p class="text-gray-600 mb-6">
                As a sponsor, you'll receive recognition on our website and annual impact reports. More importantly, you'll be part of a legacy of educational empowerment that transforms lives and strengthens communities.
            </p>

            <div class="text-center mt-12">
                <a href="mailto:scholarship@olaarowolo.com" class="btn-primary text-lg font-bold px-10 py-4 rounded-full shadow-lg inline-flex items-center justify-center">
