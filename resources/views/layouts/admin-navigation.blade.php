        ...
        <div class="flex justify-between h-16">
                ...
                <div class="hidden lg:flex lg:items-center lg:space-x-1 lg:ml-10">
                    <div class="flex flex-col w-full">
                        <x-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')"
                            class="flex items-center gap-2 text-gray-700 hover:text-yellow-500 hover:bg-gray-100 px-4 py-2 rounded-md transition">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-4">
                ...
                <a href="{{ route('admin.form-settings') }}"
                    class="flex items-center gap-2 text-gray-300 hover:text-white hover:bg-gray-700 px-4 py-2 rounded-md transition {{ request()->routeIs('admin.form-settings*') ? 'bg-gray-700 text-white' : '' }}">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden lg:hidden border-t border-gray-200">
        ...
        <div class="px-2 pt-2 pb-3 space-y-1 bg-white">
            ...
            <x-responsive-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')"
                class="flex items-center text-gray-700 hover:text-yellow-500 hover:bg-gray-100">
        ...
        <x-responsive-nav-link :href="route('two-factor.settings')"
            class="flex items-center text-gray-300 hover:text-white hover:bg-gray-700">
        ...
        <form method="POST" action="{{ route('logout') }}">
            ...
            <x-responsive-nav-link :href="route('logout')" onclick="event.preventDefault(); this.closest('form').submit();"
                class="flex items-center text-red-400 hover:text-red-300 hover:bg-red-900/20">
                <i class="fas fa-sign-out-alt w-5"></i>
                <span class="ml-3 font-medium">Log Out</span>
            </x-responsive-nav-link>
        </form>
