    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <table class="details-table">
                ...
                <tr>
                    <td>Submitted:</td>
                    <td>{{ $request->created_at->format('F d, Y \a\t h:i A') }}</td>
                </tr>
            </table>
            ...
            <div style="text-align: center;">
                <a href="{{ url('/admin/scholar-requests/' . $request->id) }}" class="button">View & Respond</a>
            </div>
        </div>
        <div class="footer">
            <p>&copy; {{ date('Y') }} OA Foundation Admin Panel</p>
        </div>
    </div>
</body>
