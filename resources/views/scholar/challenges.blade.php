            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                ...
                <form action="#" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500">Be as specific as possible to help us understand your situation</p>
                    </div>
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div class="flex">
                            ...
                            <div class="text-sm text-blue-800">
                                ...
                                <p>Your information will be kept confidential and only shared with relevant support staff to help address your challenges.</p>
                            </div>
                        </div>
                    </div>
