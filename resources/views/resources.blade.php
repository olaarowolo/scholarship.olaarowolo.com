...
<head>
    ...
    <title>Resources & Media Hub | Ola Arowolo Foundation</title>
    <!-- Tailwind CSS CDN -->
    ...
    <style>
        ...
        :root {
            --color-brand-blue: #1E40AF; /* Strong Blue */
            --color-brand-dark: #111827; /* Dark Grey/Black */
            --color-accent-gold: #F59E0B; /* Amber/Gold */
        }
...
<body class="text-gray-900">
    ...
    <!-- Hero Section -->
    <header class="bg-brand-blue text-white py-16 sm:py-24 shadow-xl">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="mt-8">
                <a href="#resources" class="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-brand-blue bg-accent-gold hover:bg-yellow-400 transition duration-300 shadow-lg">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section id="resources" class="mb-20">
            <h2 class="text-3xl sm:text-4xl font-extrabold text-brand-dark mb-10 border-b-4 border-accent-gold inline-block pb-1">
                📚 Study & Application Guides
            </h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

                <!-- Resource Card 1 -->
                <a href="#" class="resource-card block bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                    <div class="flex items-center mb-4">
                        <svg class="w-8 h-8 text-brand-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.42 9.043 5 7.007 5c-4.137 0-6.096 2.053-6.096 5.568 0 3.978 2.08 5.756 6.182 5.756C14.39 16.324 16 14.774 16 12s-1.61-4.324-6.097-4.324z"></path></svg>
                        <h3 class="ml-3 text-xl font-bold text-gray-800">JAMB Prep Blueprint</h3>
                    </div>
                    <p class="text-gray-600 text-sm">A complete 90-day study plan covering all core UTME subjects and recommended textbooks.</p>
                ...
                <a href="#" class="resource-card block bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                    ...
                    <p class="text-gray-600 text-sm">Ensure you have all the necessary documents and meet the eligibility criteria before applying.</p>
                ...
                <a href="#" class="resource-card block bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                    ...
                    <p class="text-gray-600 text-sm">Top strategies and expected questions to help you succeed in the final selection stage.</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 bg-gray-200 rounded-xl shadow-lg overflow-hidden border-2 border-brand-blue">
                    ...
                    <div class="p-4 bg-white">
                        ...
                        <p class="text-sm text-gray-600">Watch the story of how the scholarship program has transformed futures across the region.</p>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200 flex flex-col justify-between">
                    <div>
                        ...
                        <div class="flex items-center">
                            <img class="h-10 w-10 rounded-full object-cover mr-3"
                                src="https://placehold.co/40x40/1E40AF/FFFFFF?text=AA"
                    ...
                    <a href="/testimonials" class="mt-4 text-sm font-medium text-accent-gold hover:text-yellow-700">Read More Testimonials &rarr;</a>
                </div>
            </div>
        </section>
        ...
        <section id="promotional-media">
            ...
            <p class="text-gray-600 mb-6 max-w-3xl">
                Help us spread the word! Download official media kits, banners, and flyers to share on social media and local community boards.
            </p>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">

                <!-- Asset Card 1: Social Media Kit -->
                <div class="bg-white p-4 rounded-xl shadow-md text-center border border-gray-100">
                    <svg class="w-10 h-10 mx-auto text-pink-600 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V8a2 2 0 00-2-2H9a2 2 0 00-2 2v8l3-3m0-3h.01"></path></svg>
                    ...
                    <a href="#" class="mt-3 inline-block bg-accent-gold text-brand-dark text-xs font-semibold px-4 py-2 rounded-full hover:bg-yellow-600 transition duration-200">
                        Download ZIP (10MB)
                    </a>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow-md text-center border border-gray-100">
                    <svg class="w-10 h-10 mx-auto text-green-600 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                ...
                <div class="bg-white p-4 rounded-xl shadow-md text-center border border-gray-100">
                    ...
                    <a href="{{ asset('assets/img/2026_UTME_Scholarship_Application_for_Iba_Indigenes -  Web Open.jpg') }}" class="mt-3 inline-block bg-accent-gold text-brand-dark text-xs font-semibold px-4 py-2 rounded-full hover:bg-yellow-600 transition duration-200">
                        Download JPG (500KB)
                    </a>
                </div>
                ...
                <div class="bg-white p-4 rounded-xl shadow-md text-center border border-gray-100">
                    <svg class="w-10 h-10 mx-auto text-gray-700 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.5 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.5-3-9s1.343-9 3-9m-9 9h6"></path></svg>
    ...
    <!-- Footer -->
    <footer class="bg-brand-dark text-white mt-16 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p class="text-sm opacity-75">&copy; 2024 Ola Arowolo Foundation. All Rights Reserved.</p>
        </div>
    </footer>
