...
<div id="consent-popup"
    class="fixed inset-x-0 bottom-0 z-[9999] transform translate-y-full transition-transform duration-500 ease-out"
    style="display: none;">
    <!-- Overlay -->
    <div class="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm" id="consent-overlay"></div>
        ...
        <div class="p-6 sm:p-8">
            ...
            <div class="mb-6">
                <p class="text-gray-700 leading-relaxed mb-4">
                    To provide you with the best experience and protect your privacy, we need your consent to our Terms
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-800">
                                <strong>What we collect:</strong> We collect visitor data (IP address, location, browser
                                info) for analytics, and personal information only when you apply for the scholarship.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <p class="text-xs text-gray-500 text-center mt-4">
                By accepting, you allow us to collect anonymous analytics data and process your information as described
