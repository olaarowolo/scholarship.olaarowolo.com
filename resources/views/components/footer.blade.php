<footer id="contact" class="bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <!-- Navigation Links -->
            <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-8 text-left">
                <div>
                ...
                <div>
                    ...
                    <ul role="list" class="mt-4 space-y-3">
                        ...
                        <li><a href="https://olaarowolo.com"
                                class="text-base text-gray-300 hover:text-white">Sponsor</a></li>
