...
<nav class="fixed top-4 left-1/2 transform -translate-x-1/2 w-4/5 bg-white/80 backdrop-blur-md shadow-2xl rounded-full px-6 py-3 z-50 border border-accent">
    <div class="flex justify-between items-center h-10">
        ...
        <div class="hidden sm:ml-6 sm:flex sm:space-x-6 items-center">
            <a href="#mission" class="text-gray-600 hover:text-primary px-2 py-1 text-sm font-medium transition duration-200">Our Mission</a>
            <a href="#process" class="text-gray-600 hover:text-primary px-2 py-1 text-sm font-medium transition duration-200">How to Apply</a>
        ...
        <div class="flex items-center sm:hidden">
            <button type="button" class="inline-flex items-center justify-center p-1.5 rounded-md text-gray-700 hover:text-primary hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary" aria-expanded="false" onclick="toggleMenu()">
...
<div class="fixed bottom-0 left-0 w-full bg-white/80 backdrop-blur-md shadow-2xl rounded-t-3xl p-6 translate-y-full transition-transform duration-300 ease-out z-50" id="mobile-menu">
    <div class="flex flex-col space-y-4">
        <a href="#mission" class="text-gray-600 hover:text-primary py-3 text-center text-lg font-medium transition duration-200" onclick="toggleMenu()">Our Mission</a>
