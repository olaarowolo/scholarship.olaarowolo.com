    ...
    <div class="py-8 bg-gradient-to-br from-gray-50 via-white to-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <?php echo $__env->make('admin._header', [
                ...
                'actions' => '<a href="'.route('admin.applications').'" class="bg-gray-200 text-gray-800 hover:bg-gray-300 px-3 py-1 rounded-full text-sm font-semibold">View Applications</a>'
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
                ...
                <div class="stat-card bg-white overflow-hidden shadow-xl rounded-2xl border border-gray-100 animate-fadeInUp" style="animation-delay: 0.55s">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-shrink-0 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl p-3 shadow-lg">
                                <svg class="h-7 w-7 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A2 2 0 0122 9.618v4.764a2 2 0 01-1.447 1.896L15 18v-8z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10V6a4 4 0 10-8 0v4"></path>
                                </svg>
                            </div>
                ...
                <div class="stat-card bg-white overflow-hidden shadow-xl rounded-2xl border border-gray-100 animate-fadeInUp" style="animation-delay: 0.6s">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-shrink-0 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-xl p-3 shadow-lg">
                                <svg class="h-7 w-7 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 20a8 8 0 100-16 8 8 0 000 16z"></path>
                                </svg>
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <a href="<?php echo e(route('admin.scholar-requests')); ?>"
                            ...
                            <div class="flex items-center justify-between mb-3">
                                <div
                                    class="flex-shrink-0 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg p-3 shadow-lg group-hover:scale-110 transition-transform">
                                    <svg class="h-6 w-6 text-gray-900" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
