...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.navbar','data' => ['user' => auth()->user() ?? null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(auth()->user() ?? null)]); ?>
    ...
    <main class="max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-12 mb-8 sm:mb-16" style="padding-top: 100px;">
        <div class="privacy-container bg-white rounded-lg sm:rounded-xl shadow-lg p-4 sm:p-6 lg:p-8 border border-accent">
            ...
            <div class="text-center mt-6 sm:mt-8">
                ...
                <a href="<?php echo e(route('home')); ?>" class="btn-back inline-flex items-center text-sm sm:text-base">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home1/httprapu/scholarship.olaarowolo.com/resources/views/privacy.blade.php ENDPATH**/ ?>