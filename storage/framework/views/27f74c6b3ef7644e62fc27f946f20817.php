                    ...
                    <tr>
                        <td style="padding: 32px 32px 16px 32px;">
                            ...
                            <div class="mt-8 p-6 rounded-lg border-t-4"
                                ...
                                <table class="details-table" width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($application->created_at->format('F d, Y \a\t h:i A')); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>Email:</td>
                                        <td><a href="mailto:<?php echo e($application->user->email); ?>"
                                                style="color: var(--color-accent); text-decoration: none;"><?php echo e($application->user->email); ?></a>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: var(--color-alert); font-weight: 700;">
                                            <?php echo e(ucfirst($application->status)); ?></td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div align="center" class="mt-10">
                                <a href="<?php echo e(url('/admin/applications/' . $application->application_id)); ?>"
...
<?php /**PATH C:\Users\user\OneDrive\tech.olaarowolo.com\Dev\OAScholarshipLiveApp01092026\resources\views/emails/application_submitted_admin.blade.php ENDPATH**/ ?>