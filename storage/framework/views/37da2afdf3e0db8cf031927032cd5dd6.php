        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-4xl font-bold text-gray-900">Scholar Request #<?php echo e($request->id); ?></h1>
                        <p class="mt-2 text-gray-600">Submitted on <?php echo e($request->created_at->format('F d, Y \a\t g:i A')); ?>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900">
                                    <?php echo e(ucfirst(str_replace('_', ' ', $request->type ?? 'General Request'))); ?>
                            ...
                            <div>
                                ...
                                <div class="mt-2 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                    <p class="text-gray-900 whitespace-pre-wrap">
                                        <?php echo e($request->message ?? 'No message provided'); ?></p>
                                </div>
                            </div>
                            ...
                            <?php if($request->attachments): ?>
                                <div>
                                    ...
                                    <div class="mt-2 space-y-2">
                                        <?php $__currentLoopData = json_decode($request->attachments, true) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/olasunkanmiarowolo/scholarship.olaarowolo.com/resources/views/admin/scholar-request-detail.blade.php ENDPATH**/ ?>