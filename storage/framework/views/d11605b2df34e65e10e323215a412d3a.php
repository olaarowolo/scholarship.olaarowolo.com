                        ...
                        <?php $__currentLoopData = $challenges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $challenge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border rounded-xl p-6 bg-gray-50">
                                <div class="flex justify-between items-center mb-2">
                                    <span class="font-semibold text-lg text-gray-800"><?php echo e(ucfirst($challenge->challenge_type)); ?></span>
                                    <span class="text-xs px-3 py-1 rounded-full <?php echo e($challenge->status == 'submitted' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                        <?php echo e(ucfirst($challenge->status)); ?>

                                    </span>
                                </div>
                                <div class="mb-2 text-gray-700"><?php echo e($challenge->title); ?></div>
                                <div class="text-sm text-gray-500 mb-2">Severity: <?php echo e(ucfirst($challenge->severity)); ?></div>
                                <div class="text-xs text-gray-400">Submitted: <?php echo e($challenge->created_at->format('M d, Y H:i')); ?></div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/olasunkanmiarowolo/scholarship.olaarowolo.com/resources/views/scholar/my-challenges.blade.php ENDPATH**/ ?>