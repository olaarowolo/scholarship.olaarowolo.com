    ...
    <div class="nav-container">
        ...
        <div class="nav-logo">
            <a href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('assets/img/favicon/olaarowolo.com_logo_black.png')); ?>"
        ...
        <!-- Desktop Links -->
        <div class="nav-links">
            <a href="<?php echo e(route('home')); ?>#mission">Our Mission</a>
            <a href="<?php echo e(route('home')); ?>#process">How to Apply</a>
            ...
            <div class="relative inline-block impact-dropdown">
                ...
                <div id="impactDropdown"
                    ...
                    <a href="<?php echo e(route('home')); ?>#impact"
            ...
            <?php else: ?>
                <a href="<?php echo e(route('apply')); ?>" class="get-started-link"><strong>Get Started</strong></a>
...
<div id="mobile-menu" class="mobile-menu">
    <a href="<?php echo e(route('home')); ?>#mission" onclick="toggleMenu()">Our Mission</a>
    <a href="<?php echo e(route('home')); ?>#process" onclick="toggleMenu()">How to Apply</a>
    ...
    <div>
        ...
        <div id="mobileImpactDropdown" class="hidden space-y-2">
            <a href="<?php echo e(route('home')); ?>#impact" class="block py-2 text-gray-600 text-center"
                onclick="toggleMenu()">Our
                Impact</a>
            <a href="<?php echo e(route('testimonials')); ?>" class="block py-2 text-gray-600 text-center"
    ...
    <?php if(isset($user) && $user->role === 'admin'): ?>
        <div class="px-4 py-3 border-t border-gray-200 mt-2">
            <a href="<?php echo e(route('dashboard')); ?>" class="mobile-apply mb-2 block text-center"
    ...
    <?php else: ?>
        <div class="px-4 py-3 border-t border-gray-200 mt-2">
            <a href="<?php echo e(route('apply')); ?>" class="mobile-get-started mb-3 block text-center"
...
<?php /**PATH C:\Users\user\OneDrive\tech.olaarowolo.com\Dev\OAScholarshipLiveApp01092026\resources\views/components/navbar.blade.php ENDPATH**/ ?>