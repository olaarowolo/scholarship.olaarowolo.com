...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Dear <?php echo e($application->first_name); ?> <?php echo e($application->last_name); ?>,</p>
            ...
            <div class="info-box">
                <strong>Your Application ID:</strong> <?php echo e($application->application_id); ?><br>
                <strong>Submission Date:</strong> <?php echo e($application->created_at->format('F d, Y \a\t h:i A')); ?>
            ...
            <table class="details-table">
                ...
                <tr>
                    <td>Institution:</td>
                    <td><?php echo e($application->institution); ?></td>
                </tr>
                <tr>
                    <td>Course of Study:</td>
                    <td><?php echo e($application->course); ?></td>
                </tr>
                <?php if($application->jamb_score): ?>
                    <tr>
                        <td>JAMB Score:</td>
                        <td><?php echo e($application->jamb_score); ?></td>
                    </tr>
                <?php endif; ?>
                <tr>
                    <td>Status:</td>
                    <td style="color: #2563eb; font-weight: bold;"><?php echo e(ucfirst($application->status)); ?></td>
                </tr>
            </table>
            ...
            <ul>
                ...
                <li>You will receive updates via email at
                    <strong><?php echo e($application->user->email ?? 'your registered email'); ?></strong>
                </li>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(url('/dashboard')); ?>" class="button">View Your Dashboard</a>
            </div>
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> OA Foundation & Scholarship Program. All rights reserved.</p>
...
<?php /**PATH C:\Users\user\OneDrive\tech.olaarowolo.com\Dev\OAScholarshipLiveApp01092026\resources\views/emails/application_submitted.blade.php ENDPATH**/ ?>