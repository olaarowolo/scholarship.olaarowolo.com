            ...
            <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-7 lg:text-left">
                ...
                <div
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a id="apply-btn-auth" href="<?php echo e(route('apply-form')); ?>"
                    ...
                    <?php else: ?>
                        <a id="apply-btn-guest" href="<?php echo e(route('register')); ?>"
                            class="btn-primary text-lg font-bold px-10 py-4 rounded-full shadow-lg inline-flex items-center justify-center transition-all duration-300 hover:scale-105 hover:shadow-2xl"
                            style="display: none;">
            ...
            <div class="mt-16 lg:mt-0 lg:col-span-5 animate-fade-in-right animation-delay-400">
                <div
                    ...
                    <img class="w-full h-auto rounded-3xl"
                        src="<?php echo e(asset('assets/img/2025_UTME_Scholarship_Application_for_Iba_Indigenes -  Web Open.jpg')); ?>"
...
<script>
    ...
    function shareApplyPage() {
        const applyUrl = '<?php echo e(route('apply')); ?>';
...
<?php /**PATH C:\Users\user\OneDrive\tech.olaarowolo.com\Dev\OAScholarshipLiveApp01092026\resources\views/components/header.blade.php ENDPATH**/ ?>