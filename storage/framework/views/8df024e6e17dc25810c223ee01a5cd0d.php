        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                <div class="px-8 pt-8 pb-10">
                    <form action="<?php echo e(route('scholar.login')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="px-8 py-6 bg-gray-50 border-t border-gray-200">
                    <p class="text-center text-sm text-gray-600">
                        ...
                        <a href="<?php echo e(route('scholar-register')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\OneDrive\tech.olaarowolo.com\Dev\OAScholarshipLiveApp01092026\resources\views/scholar-login.blade.php ENDPATH**/ ?>