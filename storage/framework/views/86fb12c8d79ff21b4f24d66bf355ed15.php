        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    <div>
                        <a href="<?php echo e(route('dashboard')); ?>"
                            class="text-sm text-gray-600 hover:text-black mb-2 inline-flex items-center">
                        ...
                        <h1 class="text-5xl font-extrabold text-gray-900 tracking-tight mt-2">Export Data & Reports</h1>
                        <p class="mt-2 text-lg text-gray-600">Download application and user data in various formats</p>
                    </div>
                    <span
                        class="mt-4 sm:mt-0 inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-black text-white">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-green-600 mt-2"><?php echo e($statusCounts['approved']); ?></p>
                        </div>
            ...
            <div class="bg-gradient-to-r from-gray-100 to-gray-200 rounded-xl shadow-xl p-8 mb-10">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    ...
                    <a href="<?php echo e(route('admin.export.summary')); ?>"
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-200 mb-8">
                ...
                <form action="<?php echo e(route('admin.export.applications')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="pending">Pending (<?php echo e($statusCounts['pending']); ?>)</option>
                                <option value="approved">Approved (<?php echo e($statusCounts['approved']); ?>)</option>
                                <option value="rejected">Rejected (<?php echo e($statusCounts['rejected']); ?>)</option>
                            </select>
                        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
                ...
                <form action="<?php echo e(route('admin.export.users')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-end">
                            <div class="text-sm text-gray-600">
                                <p class="font-semibold mb-1">Total Users: <?php echo e($totalUsers); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/olasunkanmiarowolo/scholarship.olaarowolo.com/resources/views/admin/export.blade.php ENDPATH**/ ?>