    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="flex items-start space-x-4 md:col-span-2">
                <img class="h-24 w-auto" src="<?php echo e(asset('assets/img/favicon/olaarowolo.com_logo_black.png')); ?>"
            ...
            <div class="text-left">
                ...
                <ul role="list" class="mt-4 space-y-3">
                    ...
                    <li><a href="<?php echo e(route('view-impact')); ?>" class="text-base text-gray-300 hover:text-white">View
                            Impact</a></li>
                    <li><a href="<?php echo e(route('how-it-works')); ?>" class="text-base text-gray-300 hover:text-white">How It
                            Works</a></li>
                </ul>
            </div>
            <!-- Portal & Legal -->
            <div class="text-left">
                ...
                <ul role="list" class="mt-4 space-y-3">
                    <li><a href="<?php echo e(route('scholar-login')); ?>" class="text-base text-gray-300 hover:text-white">Scholar
                            Login</a></li>
                    ...
                    <li><a href="<?php echo e(route('terms')); ?>" class="text-base text-gray-300 hover:text-white">Terms &
                            Conditions</a></li>
                    <li><a href="<?php echo e(route('privacy')); ?>" class="text-base text-gray-300 hover:text-white">Privacy
                            Policy</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="text-base text-gray-300 hover:text-white">Contact Us</a>
                    </li>
        ...
        <div class="mt-12 border-t border-gray-700 pt-8">
            ...
            <div class="mt-4 text-center text-sm text-gray-500">
                ...
                <span class="mx-2">|</span>
                <a href="<?php echo e(route('contact')); ?>" class="hover:text-white">Contact</a>
            </div>
        </div>
    </div>
</footer>
<?php /**PATH C:\Users\user\OneDrive\tech.olaarowolo.com\Dev\OAScholarshipLiveApp01092026\resources\views/partials/footer.blade.php ENDPATH**/ ?>