    ...
    <div class="min-h-screen pt-12 pb-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    <div>
                        ...
                        <p class="mt-2 text-lg text-gray-600">Application ID: <span
                                class="font-mono text-sm"><?php echo e($application->application_id); ?></span></p>
                    </div>
                    <span
                        class="mt-4 sm:mt-0 px-4 py-2 rounded-full text-sm font-bold <?php echo e($statusData['bg']); ?> <?php echo e($statusData['text']); ?>">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="pending" <?php echo e($application->status == 'pending' ? 'selected' : ''); ?>>Pending
                                </option>
                                <option value="approved" <?php echo e($application->status == 'approved' ? 'selected' : ''); ?>>Approved
                                </option>
                                <option value="rejected" <?php echo e($application->status == 'rejected' ? 'selected' : ''); ?>>Rejected
                                </option>
                            </select>
                        </div>
                        ...
                        <div>
                            <label for="notes" class="block text-sm font-medium text-gray-700 mb-2">Admin Notes
                                (Optional)</label>
                            <input type="text" name="notes" id="notes" value="<?php echo e($application->notes ?? ''); ?>"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black"
                ...
                <div class="lg:col-span-2 bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-base text-gray-900"><?php echo e($application->middle_name ?? 'N/A'); ?></p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-base text-gray-900">
                                <?php echo e(\Carbon\Carbon::parse($application->date_of_birth)->format('M d, Y')); ?></p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 mb-1">Gender</label>
                            <p class="text-base text-gray-900"><?php echo e(ucfirst($application->gender)); ?></p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 mb-1">State of Origin</label>
                            <p class="text-base text-gray-900"><?php echo e($application->state_of_origin); ?></p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 mb-1">LGA of Origin</label>
                            <p class="text-base text-gray-900"><?php echo e($application->lga_of_origin); ?></p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 mb-1">Lagos State Indigene</label>
                            <p class="text-base text-gray-900">
                                <?php if($application->is_ondo_indigene): ?>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="text-base text-gray-900"><?php echo e($application->home_address); ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="text-sm text-gray-900"><?php echo e($application->created_at->format('M d, Y')); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($application->created_at->diffForHumans()); ?></p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-500 mb-1">Last Updated</label>
                                <p class="text-sm text-gray-900"><?php echo e($application->updated_at->format('M d, Y')); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($application->updated_at->diffForHumans()); ?></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-6 bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-base text-gray-900"><?php echo e(ucfirst($application->level)); ?></p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-1">JAMB Registration Number</label>
                        <p class="text-base text-gray-900 font-mono text-sm"><?php echo e($application->jamb_reg_number); ?></p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-1">JAMB Score</label>
                        <p class="text-base text-gray-900 font-bold text-lg"><?php echo e($application->jamb_score); ?></p>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-1">JAMB Year</label>
                        <p class="text-base text-gray-900"><?php echo e($application->jamb_year); ?></p>
                    </div>
                </div>
            </div>
                    ...
                    <?php if($application->jamb_result_path): ?>
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition duration-200">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="<?php echo e(Storage::url($application->jamb_result_path)); ?>" target="_blank"
                    ...
                    <?php if($application->waec_result_path): ?>
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition duration-200">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="<?php echo e(Storage::url($application->waec_result_path)); ?>" target="_blank"
                                    class="text-sm text-black hover:text-blue-600 font-medium">
                                    View →
                                </a>
                            </div>
                    ...
                    <?php if($application->indigene_certificate_path): ?>
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition duration-200">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="<?php echo e(Storage::url($application->indigene_certificate_path)); ?>" target="_blank"
                                    class="text-sm text-black hover:text-blue-600 font-medium">
                                    View →
                                </a>
                            </div>
                    ...
                    <?php if($application->admission_letter_path): ?>
                        <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition duration-200">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="<?php echo e(Storage::url($application->admission_letter_path)); ?>" target="_blank"
                                    class="text-sm text-black hover:text-blue-600 font-medium">
                                    View →
                                </a>
                            </div>
            ...
            <div class="mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <form action="<?php echo e(route('admin.applications.delete', $application->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home1/httprapu/scholarship.olaarowolo.com/resources/views/admin/application-detail.blade.php ENDPATH**/ ?>
