    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center pt-48 pb-8 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-3xl mx-auto flex flex-col items-center justify-center">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                ...
                <form action="<?php echo e(route('scholar.requests.store.create')); ?>" method="POST" enctype="multipart/form-data"
                    class="space-y-6">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home1/httprapu/scholarship.olaarowolo.com/resources/views/scholar/requests/create.blade.php ENDPATH**/ ?>