<?php $__env->startSection('content'); ?>
        ...
        <section id="promotional-media">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-4 rounded-xl shadow-md text-center border border-gray-100">
                    ...
                    <a href="<?php echo e(asset('assets/img/2026_UTME_Scholarship_Application_for_Iba_Indigenes -  Web Open.jpg')); ?>"
                        download
    ...
    <script>
        function shareFlier() {
            const flierUrl = '<?php echo e(url('assets/img/2026_UTME_Scholarship_Application_for_Iba_Indigenes -  Web Open.jpg')); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\OneDrive\tech.olaarowolo.com\Dev\OAScholarshipLiveApp01092026\resources\views/resources.blade.php ENDPATH**/ ?>