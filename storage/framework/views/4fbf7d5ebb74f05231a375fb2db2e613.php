    ...
    <div class="min-h-screen pt-6 md:pt-12 pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200 mb-6">
                <form method="GET" action="<?php echo e(route('admin.scholar-requests')); ?>" class="flex items-end space-x-4">
                    <!-- Status Filter -->
                    <div class="flex-1">
                        ...
                        <?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white border rounded-lg p-4 shadow-sm">
                                <div class="flex items-start justify-between">
                                    <div class="min-w-0">
                                        <p class="text-sm font-semibold text-gray-900 truncate">#<?php echo e($request->id); ?> — <?php echo e($request->user->name ?? 'N/A'); ?></p>
                                        <p class="text-xs text-gray-500 mt-1"><?php echo e(ucfirst(str_replace('_', ' ', $request->request_type ?? ''))); ?> • <?php echo e($request->created_at->format('M d, Y')); ?></p>
                                        <p class="text-sm text-gray-700 mt-2 truncate"><?php echo e(\Illuminate\Support\Str::limit($request->subject ?? $request->description ?? 'No subject', 90)); ?></p>
                                    </div>
                                    <div class="ml-3 flex-shrink-0 text-right space-y-2">
                                        <?php $statusClass = $statusColors[$request->status] ?? 'bg-gray-100 text-gray-800'; ?>
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold <?php echo e($statusClass); ?>"><?php echo e(ucfirst(str_replace('_', ' ', $request->status))); ?></span>
                                        <a href="<?php echo e(route('admin.scholar-requests.show', $request->id)); ?>" class="text-sm font-semibold text-black block">View →</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tr class="hover:bg-gray-50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e($request->user->name ?? 'N/A'); ?></div>
                                            <div class="text-sm text-gray-500"><?php echo e($request->user->email ?? 'N/A'); ?></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e(ucfirst(str_replace('_', ' ', $request->type ?? 'general'))); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="<?php echo e(route('admin.scholar-requests.show', $request->id)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\OneDrive\tech.olaarowolo.com\Dev\OAScholarshipLiveApp01092026\resources\views/admin/scholar-requests.blade.php ENDPATH**/ ?>